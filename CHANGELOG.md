...
- Update libs:
  ...
  - `ssh2-sftp-client` from `v12.0.1` to `v12.1.0`.
- Update _dev_ libs:
  ...
  - `@eslint/js` from `v9.38.0` to `v10.0.1`.
  - `@trivago/prettier-plugin-sort-imports` from `v5.2.2` to `v6.0.2`.
  - `@types/ssh2-sftp-client` from `v9.0.5` to `v9.0.6`.
...
- Update libs:
    ...
    - `ssh2-sftp-client` from `v11.0.0` to `v12.0.1`.
- Update _dev_ libs:
    ...
    - `@types/ssh2-sftp-client` from `v9.0.4` to `v9.0.5`.
